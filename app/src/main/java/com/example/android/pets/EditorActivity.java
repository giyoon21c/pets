...
public class EditorActivity extends AppCompatActivity {
    ...
    private void insertPet() {
        ...
        values.put(PetContract.PetEntry.COLUMN_PET_WEIGHT, Integer.parseInt(weightString));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                // save pet to db
                insertPet();
                // exit the editor to go back to the catalog activity
                finish();
                return true;
